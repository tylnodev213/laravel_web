...
<div class="data">
    ...
    <table width="100%" border="1" cellspacing="0" class="table table-striped">
        ...
        <tr>
            ...
            <td class="column text-center col-md-2"><a href="edit/" class="btn btn-edit">Edit</a><a href="delete/" onclick="return confirm('Are you sure?')" class="btn btn-del" id="delete">Delete</a></td>
        </tr>
        @endforeach
    </table>
</div>
