...
<form class="form_container" action="{{route('Team.edit_confirm', $team)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form_box">
        ...
        <div class="row form_input">
            ...
            <input type="text" name="name" maxlength="128" class="col-md-4 search_box__form--input" value="{{$team->name}}">
        </div>
        <div class="row form_input">
