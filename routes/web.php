...
Route::group(['prefix'=>'Team', 'as'=>'Team.', 'middleware'=> CheckLoginMiddleware::class],function () {
    ...
    Route::post('/create_confirm', [TeamController::class, 'createConfirm'])->name('create_confirm');
    ...
    Route::post('/edit/{team}', [TeamController::class, 'editConfirm'])->name('edit_confirm');
...
Route::group(['prefix'=>'Employee', 'as'=>'Employee.', 'middleware'=> CheckLoginMiddleware::class],function () {
    ...
    Route::post('/create_confirm', [EmployeeController::class, 'createConfirm'])->name('create_confirm');
    ...
    Route::post('/edit/{employee}', [EmployeeController::class, 'editConfirm'])->name('edit_confirm');
